<?php
    ...
    if ($authentified) {
        //Now the marchand is supposed to compare his order data and the response data and update his database.
        ...
        $threedsStatus = (isset($_REQUEST['vads_threeds_status'])) ? $i18n[ 'vads_threeds_status_' . $_REQUEST['vads_threeds_status']] : $i18n['vads_threeds_status_x'];
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel">
                    ...
                    <input class="forminput" type="text" id="vads_trans_status" name="vads_trans_status" value="<?php echo $_REQUEST['vads_trans_status']; ?>">
                    <label style="width: 60%" for="vads_trans_status"><?php echo $i18n['vads_trans_status'] .' : '. $transStatus; ?></label><br>

                    <label style="width: 15%" for="vads_result">vads_result</label>
                    <input class="forminput" type="text" id="vads_result" name="vads_result" value="<?php echo $_REQUEST['vads_result']; ?>">
                    <label style="width: 60%" for="vads_result"><?php echo $i18n['result'] .' : '. $result; ?></label><br>

                    <label style="width: 15%" for="vads_trans_id">vads_trans_id</label>
                    <input class="forminput" type="text" id="vads_trans_id" name="vads_trans_id" value="<?php echo $_REQUEST['vads_trans_id']; ?>">
                    ...
                    <input class="forminput" type="text" id="vads_amount" name="vads_amount" value="<?php echo $_REQUEST['vads_amount']; ?>">
                    <label style="width: 60%" for="vads_amount"><?php echo $i18n['vads_trans_status']; ?></label><br>

                    <label style="width: 15%" for="vads_effective_amount">vads_effective_amount</label>
                    <input class="forminput" type="text" id="vads_effective_amount" name="vads_effective_amount" value="<?php echo $_REQUEST['vads_effective_amount']; ?>">
                    <label style="width: 60%" for="vads_effective_amount"><?php echo $i18n['vads_effective_amount'] . $i18n['vads_effective_amount_desc']; ?></label><br>

                    <label style="width: 15%" for="vads_payment_config">vads_payment_config</label>
                    <input class="forminput" type="text" id="vads_payment_config" name="vads_payment_config" value="<?php echo $_REQUEST['vads_payment_config']; ?>">
                    <label style="width: 60%" for="vads_payment_config"><?php echo $i18n['vads_payment_config'] .' : ' . $paymentConfig; ?></label><br>

                    <label style="width: 15%" for="vads_sequence_number">vads_sequence_number</label>
                    <input class="forminput" type="text" id="vads_sequence_number" name="vads_sequence_number" value="<?php echo $_REQUEST['vads_sequence_number']; ?>">
                    <label style="width: 60%" for="vads_sequence_number"><?php echo $i18n['vads_sequence_number'] ?></label><br>

                    <label style="width: 15%" for="vads_auth_result">vads_auth_result</label>
                    <input class="forminput" type="text" id="vads_auth_result" name="vads_auth_result" value="<?php echo $_REQUEST['vads_auth_result']; ?>">
                    <label style="width: 60%" for="vads_auth_result"><?php echo $i18n['vads_auth_result'] .' : '. $authResult; ?></label><br>

                    <label style="width: 15%" for="vads_warranty_result">vads_warranty_result</label>
                    <input class="forminput" type="text" id="vads_warranty_result" name="vads_warranty_result" value="<?php echo $_REQUEST['vads_warranty_result']; ?>">
                    <label style="width: 60%" for="vads_warranty_result"><?php echo $i18n['vads_warranty_result'] .' : '. $warrantyResult; ?></label><br>

                    <label style="width: 15%" for="vads_threeds_status">vads_threeds_status</label>
                    <input class="forminput" type="text" id="vads_threeds_status" name="vads_threeds_status" value="<?php echo $_REQUEST['vads_threeds_status']; ?>">
                    <label style="width: 60%" for="vads_threeds_status"><?php echo $i18n['vads_threeds_status'] .' : '. $threedsStatus; ?></label><br>

                    <label style="width: 15%" for="vads_capture_delay">vads_capture_delay</label>
                    <input class="forminput" type="text" id="vads_capture_delay" name="vads_capture_delay" value="<?php echo $_REQUEST['vads_capture_delay']; ?>">
                    <label style="width: 60%" for="vads_capture_delay"><?php echo $i18n['vads_capture_delay'] .' : '. $captureDelay; ?></label><br>

                    <label style="width: 15%" for="vads_validation_mode">vads_validation_mode</label>
                    <input class="forminput" type="text" id="vads_validation_mode" name="vads_validation_mode" value="<?php echo $_REQUEST['vads_validation_mode']; ?>">
                    <label style="width: 60%" for="vads_validation_mode"><?php echo $i18n['vads_validation_mode'] .' : '. $validationMode; ?></label><br>
