<?php
    ...
    if(isset($_REQUEST['vads_language']) && in_array($_REQUEST['vads_language'], array('en', 'fr'))){
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel">
                    ...
                    <input class="forminput" type="text" id="vads_trans_status" name="vads_trans_status" value="<?php echo $_REQUEST['vads_trans_status']; ?>"  readonly>
                    ...
                    <input class="forminput" type="text" id="vads_result" name="vads_result" value="<?php echo $_REQUEST['vads_result']; ?>"  readonly>
                    ...
                    <input class="forminput" type="text" id="vads_trans_id" name="vads_trans_id" value="<?php echo $_REQUEST['vads_trans_id']; ?>"  readonly>
                    ...
                    <input class="forminput" type="text" id="vads_amount" name="vads_amount" value="<?php echo $_REQUEST['vads_amount']; ?>" readonly>
                    ...
                    <input class="forminput" type="text" id="vads_effective_amount" name="vads_effective_amount" value="<?php echo $_REQUEST['vads_effective_amount']; ?>" readonly>
                    ...
                    <input class="forminput" type="text" id="vads_payment_config" name="vads_payment_config" value="<?php echo $_REQUEST['vads_payment_config']; ?>" readonly>
                    ...
                    <input class="forminput" type="text" id="vads_sequence_number" name="vads_sequence_number" value="<?php echo $_REQUEST['vads_sequence_number']; ?>" readonly>
                    ...
                    <input class="forminput" type="text" id="vads_auth_result" name="vads_auth_result" value="<?php echo $_REQUEST['vads_auth_result']; ?>" readonly>
                    ...
                    <input class="forminput" type="text" id="vads_warranty_result" name="vads_warranty_result" value="<?php echo $_REQUEST['vads_warranty_result']; ?>" readonly>
                    ...
                    <input class="forminput" type="text" id="vads_threeds_status" name="vads_threeds_status" value="<?php echo $_REQUEST['vads_threeds_status']; ?>" readonly>
                    ...
                    <input class="forminput" type="text" id="vads_capture_delay" name="vads_capture_delay" value="<?php echo $_REQUEST['vads_capture_delay']; ?>" readonly>
                    ...
                    <input class="forminput" type="text" id="vads_validation_mode" name="vads_validation_mode" value="<?php echo $_REQUEST['vads_validation_mode']; ?>" readonly>
            ...
            <div class="panel">
                <?php foreach ($_REQUEST as $key => $value){ ?>
                    ...
                    <input class="forminput" type="text" id="<?php echo $key; ?>" name="<?php echo $key; ?>" value="<?php echo $value; ?>"  readonly><br>
                <?php } ?>
            </div>
            <?php } ?>
            <br />
