...
$sub_info = array (
    ...
    // that respect the iCalendar (Internet Calendar) specification, described in RFC5545 (see http://tools.ietf
    //.org/html/rfc5545).
    'sub_effect_date' => date('Ymd',
                              strtotime('+1 month')
    ), // The effective date indicates from which
...
// Order Info.
$order_info = array_merge($_REQUEST,
                          $sub_info
);
