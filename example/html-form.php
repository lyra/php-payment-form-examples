    ...
    <div class="row">
        <div class="col-lg-12" style="max-width: 92%;">
            ...
            <div class="bg-info">
                ...
                <h2><?php echo gettext('PAYZEN PAYMENT SOLUTION IMPLEMENTATION EXAMPLE'); ?> </h2>
                <div id="Info">
                    <p><b><?php echo gettext('INFORMATIONS'); ?></b></p>
                    <p><?php echo gettext("The payment uses the sending of a payment form to PAYZEN payment gateway URL."); ?></p>
                    <p><strong><?php echo gettext('File'); ?> config.php</strong></p>
                    <p><?php echo gettext('Before the first use you have to fill the <code>shopID</code>, <code>certTest</code>, <code>platform</code> and <code>ctxMode</code> of the <code>config/config.php</code>.e. This file contains secure data.  <b>This data securing is on your responsibility.</b>'); ?></p>

                    <p><strong><u><?php echo gettext('File'); ?> html-form.php</u></strong></p>
                    <p><?php echo gettext("the file <code>html-form.php</code> sends these payment fields to the<code>form-tunnel.php</code>  which fetch these fields to create the payment request.</p>
...
<form style="margin-top:10px;" method="POST" action="form-tunnel.php">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
        <tr>
            <td colspan="3" class="title_array"><h2><?php echo gettext('TRANSACTION SETTINGS'); ?></h2></td>
        </tr>
        <tr>
            ...
            <td  class="text-right text-danger">
                <?php echo gettext('Order amount set in the smallest currency unit. Cents for EURO. Ex: 1000 for 10 euros'); ?></td>
        </tr>

        <tr>
            <td colspan="3"><h3><?php echo gettext('CLIENT SETTINGS'); ?></h3></td>
        </tr>
        ...
        <tr>
            ...
            <td><?php echo gettext('Order number. Optional setting. Length of field: 32 characters max - Alphanumeric Type'); ?></td>
        </tr>
        ...
        <tr>
            ...
            <td class="text-right"><?php echo gettext('Customer number. Optional setting. Length of field: 32 characters max - Alphanumeric Type'); ?></td>
        </tr>
        <tr>
            ...
            <td class="text-right"><?php echo gettext('Customer name. Optional setting. Length of field: 127 characters max - Alphanumeric Type'); ?></td>
        </tr>
        <tr>
            ...
            <td class="text-right"><?php echo gettext('Customer address. Optional setting. Length of field: 255 characters max - Alphanumeric Type'); ?></td>
        </tr>
        <tr>
            ...
            <td class="text-right"><?php echo gettext('Customer Postal Code. Optional setting. Length of field: 32 characters max - Alphanumeric Type'); ?></td>
        </tr>
        <tr>
            ...
            <td class="text-right"><?php echo gettext('Customer City. Optional setting. Length of field: 63 characters max - Alphanumeric Type'); ?></td>
        </tr>
        <tr>
            ...
            <td class="text-right"><?php echo gettext('Customer Country. Customer country code according to the ISO 3166 norm. Optional setting. Length of field: 2 characters max - Alphanumeric Type'); ?></td>
        </tr>
        <tr>
            ...
            <td class="text-right"><?php echo gettext('Customer Phone Number. Optional setting. Length of field: 32 characters max - Alphanumeric Type'); ?></td>
        </tr>
        <tr>
            ...
            <td class="text-right"><?php echo gettext('Customer Email. Optional setting.'); ?></td>
        </tr>

        <tr>
            <td colspan="3"><h3><?php echo gettext('RETURN URL'); ?></h3></td>
        </tr>
        ...
        <tr>
            ...
            <td><?php echo gettext('Default URL to where the buyer will be redirected. If this field has not been transmitted, the Back Office configuration will be taken into account.'); ?></td>
        </tr>
        <tr>
            ...
            <td><?php echo gettext('delay in seconds before an automatic redirection to the merchant website at the end of an accepted payment.'); ?></td>
        </tr>
    ...
    <button type="submit" class="btn btn-primary btn-lg btn-block">
        <?php echo gettext('Validate and send the settings  <br>by POST mode to'); ?> form-tunnel.php
    </button>
</form>
</div>
        </div>
