...
if (! class_exists('Request',
    ...
    class Request
    {
        ...
        {
            // Initialize encoding.
            $this->encoding = in_array(strtoupper($encoding),
            ...
            $regex_payment_option =
                '#^[a-zA-Z0-9]{0,32}$|^COUNT=([1-9][0-9]{0,2})?;RATE=[0-9]{0,4}(\\.[0-9]{1,4})?;DESC=.{0,64};?$#';
            ...
            $this->addField('vads_available_languages',
                            'Available languages',
                            '#^(|[A-Za-z]{2}(;[A-Za-z]{2})*)$#u',
                            false,
                            2
            ...
            $this->addField('vads_contracts',
                            'Contracts',
                            $ans255
            );
            $this->addField('vads_contrib',
                            'Contribution',
                            $ans255
            );
            ...
            $this->addField('vads_cust_antecedents',
                            'Customer history',
                            '#^NONE|NO_INCIDENT|INCIDENT$#u'
            );
            $this->addField('vads_cust_cell_phone',
                            'Customer cell phone',
                            $an63,
                            false,
                            63
            ...
            $this->addField('vads_cust_first_name',
                            'Customer first name',
                            $an63,
                            false,
                            63
            ...
            $this->addField('vads_cust_last_name',
                            'Customer last name',
                            $an63,
                            false,
                            63
            );
            $this->addField('vads_cust_legal_name',
                            'Customer legal name',
                            '#^' . $ans . '{0,100}$#u',
                            false,
                            100
            ...
            $this->addField('vads_cust_state',
                            'Customer state/region',
                            '#^' . $ans . '{0,63}$#u',
                            false,
                            63
            );
            $this->addField('vads_cust_status',
            ...
            $this->addField('vads_identifier',
                            'Identifier',
                            '#^' . $ans . '{0,50}$#u',
                            false,
                            50
            );
            $this->addField('vads_insurance_amount',
            ...
            $this->addField('vads_nb_products',
                            'Number of products',
                            '#^' . $supzero . '$#u',
                            false
            );
            ...
            $this->addField('vads_order_info2',
                            'Order info 2',
                            $ans255
            );
            $this->addField('vads_order_info3',
                            'Order info 3',
                            $ans255
            );
            $this->addField('vads_page_action',
                            'Page action',
                            '#^PAYMENT$#u',
                            true,
                            7
            );
            $this->addField('vads_payment_cards',
                            'Payment cards',
            ...
            $this->addField('vads_payment_option_code',
                            'Payment option to use',
                            $regex_payment_option,
                            false
            );
            ...
            $this->addField('vads_redirect_error_message',
                            'Redirection error message',
                            $ans255,
                            false
            );
            $this->addField('vads_redirect_error_timeout',
                            'Redirection error timeout',
                            $ans255,
                            false
            );
            $this->addField('vads_redirect_success_message',
                            'Redirection success message',
                            $ans255,
                            false
            );
            $this->addField('vads_redirect_success_timeout',
                            'Redirection success timeout',
                            $ans255,
                            false
            );
            $this->addField('vads_return_get_params',
            ...
            $this->addField('vads_return_post_params',
                            'POST return parameters',
                            $regex_params,
                            false
            );
            $this->addField('vads_ship_to_city',
                            'Shipping city',
                            '#^' . $ans . '{0,63}$#u',
                            false,
                            63
            );
            $this->addField('vads_ship_to_country',
                            'Shipping country',
                            '#^[A-Za-z]{2}$#u',
                            false,
                            2
            );
            $this->addField('vads_ship_to_delay',
                            'Delay of shipping',
                            '#^INFERIOR_EQUALS|SUPERIOR|IMMEDIATE|ALWAYS$#u',
                            false,
                            15
            );
            $this->addField('vads_ship_to_delivery_company_name',
                            'Name of the delivery company',
                            $ans127,
                            false,
                            127
            );
            $this->addField('vads_ship_to_first_name',
                            'Shipping first name',
                            $an63,
                            false,
                            63
            );
            $this->addField('vads_ship_to_last_name',
                            'Shipping last name',
                            $an63,
                            false,
                            63
            );
            $this->addField('vads_ship_to_legal_name',
                            'Shipping legal name',
                            '#^' . $ans . '{0,100}$#u',
                            false,
                            100
            );
            $this->addField('vads_ship_to_name',
                            'Shipping name',
                            '#^' . $ans . '{0,127}$#u',
                            false,
                            127
            );
            $this->addField('vads_ship_to_phone_num',
                            'Shipping phone',
                            $ans255,
                            false,
                            63
            );
            $this->addField('vads_ship_to_speed',
                            'Speed of the shipping method',
                            '#^STANDARD|EXPRESS|PRIORITY$#u',
                            false,
                            8
            );
            $this->addField('vads_ship_to_state',
                            'Shipping state',
                            $an63,
                            false,
                            63
            );
            $this->addField('vads_ship_to_status',
                            'Shipping status (private or company)',
                            '#^PRIVATE|COMPANY$#u',
                            false,
                            7
            );
            $this->addField('vads_ship_to_street',
                            'Shipping street',
                            $ans127,
                            false,
                            127
            );
            $this->addField('vads_ship_to_street2',
                            'Shipping street (2)',
                            $ans127,
                            false,
                            127
            );
            $this->addField('vads_ship_to_type',
                            'Type of the shipping method',
                            $regex_ship_type,
                            false,
                            24
            );
            $this->addField('vads_ship_to_zip',
                            'Shipping zip code',
                            $an63,
                            false,
                            63
            );
            $this->addField('vads_shipping_amount',
                            'The amount of shipping',
                            '#^' . $supzero . '$#u',
                            false,
                            12
            );
            $this->addField('vads_shop_name',
                            'Shop name',
                            $ans127
            );
            $this->addField('vads_shop_url',
                            'Shop URL',
                            '#^https?://(\w+(:\w*)?@)?(\S+)(:[0-9]+)?[\w\#!:.?+=&%@`~;,|!\-/]*$#u'
            );
            ...
            $this->addField('vads_tax_amount',
                            'The amount of tax',
                            '#^' . $supzero . '$#u',
                            false,
                            12
            );
            $this->addField('vads_tax_rate',
                            'The rate of tax',
                            '#^\d{1,2}\.\d{1,4}$#u',
                            false,
                            6
            ...
            $this->addField('vads_totalamount_vat',
                            'The total amount of VAT',
                            '#^' . $supzero . '$#u',
                            false,
                            12
            );
            $this->addField('vads_threeds_mpi',
            ...
            $this->addField('vads_url_cancel',
                            'Cancel URL',
                            $ans127,
                            false,
                            127
            );
            $this->addField('vads_url_error',
                            'Error URL',
                            $ans127,
                            false,
                            127
            );
            $this->addField('vads_url_referral',
                            'Referral URL',
                            $ans127,
                            false,
                            127
            );
            $this->addField('vads_url_refused',
                            'Refused URL',
                            $ans127,
                            false,
                            127
            );
            $this->addField('vads_url_return',
                            'Return URL',
                            $ans127,
                            false,
                            127
            );
            $this->addField('vads_url_success',
                            'Success URL',
                            $ans127,
                            false,
                            127
            ...
            $this->addField('vads_sub_amount',
                            'Subscription amount',
                            '#^' . $supzero . '$#u'
            );
            $this->addField('vads_sub_currency',
                            'Subscription currency',
                            '#^\d{3}$#u',
                            false,
                            3
            );
            $this->addField('vads_sub_desc',
                            'Subscription description',
                            $ans255
            );
            $this->addField('vads_sub_effect_date',
                            'Subscription effect date',
                            $regex_sub_effect_date
            );
            $this->addField('vads_sub_init_amount',
                            'Subscription initial amount',
                            '#^' . $supzero . '$#u'
            );
            $this->addField('vads_sub_init_amount_number',
                            'subscription initial amount number',
                            '#^\d+$#u'
            );

            // Set some default values.
            $this->set('vads_version',
                       'V2'
            );
            $this->set('vads_page_action',
                       'PAYMENT'
            );
            $this->set('vads_action_mode',
                       'INTERACTIVE'
            );
            $this->set('vads_payment_config',
                       'SINGLE'
            );

            $timestamp = time();
            $this->set('vads_trans_id',
                       Api::generateTransId($timestamp)
            );
            $this->set('vads_trans_date',
                       gmdate('YmdHis',
                              $timestamp
                       )
            );
        ...
        {
            $this->requestParameters[$name] = new Field($name,
                                                        $label,
                                                        $regex,
                                                        $required,
                                                        $length
        ...
        public function set ($name, $value)
        {
            ...
            if (is_string($value)) {
                ...
                $value = preg_replace(array ('#[<>]+#u', '#\s+#u'),
                                      array ('', ' '),
                                      $value);
            }
         ...
         *
         * @param $total_in_cents number total order amount in cents
         * @param $first_in_cents number amount of the first payment in cents
         * @param $count number total of payments
        ...
        public function setMultiPayment ($total_in_cents = null, $first_in_cents = null, $count = 3, $period = 30)
        {
            ...
            if (is_numeric($count) && $count > 1 && is_numeric($period) && $period > 0) {
                ...
                if (is_numeric($total_in_cents) && $total_in_cents > $first_in_cents
                    ...
                    $result &= $this->set('amount',
                                          $total_in_cents
                    );
                    $result &= $this->set('payment_config',
                                          $payment_config
                    );
                }
            }
        ...
        /**
         * Set TEST or PRODUCTION Key.
         *
         * @param string $key
         * @param string $mode
         * @return boolean
         */
        public function setKey ($key, $mode)
        {
            if ($mode == 'TEST') {
                $this->keyTest = $key;
        ...
        public function addProduct ($label, $amount, $qty, $ref, $type = null, $vat = null)
        {
            ...
            $ok &= $this->addField('product_label' . $index,
                                   'Product label',
                                   '#^[^<>"+-]{0,255}$#u',
                                   false,
                                   255,
            ...
            $ok &= $this->addField('product_amount' . $index,
                                   'Product amount',
                                   '#^[1-9]\d*$#u',
                                   false,
                                   12,
            ...
            $ok &= $this->addField('product_qty' . $index,
                                   'Product quantity',
                                   '#^[1-9]\d*$#u',
                                   false,
                                   255,
            ...
            $ok &= $this->addField('product_ref' . $index,
                                   'Product reference',
                                   '#^[A-Za-z0-9]{0,64}$#u',
                                   false,
                                   64,
            ...
            $ok &= $this->addField('product_type' . $index,
                                   'Product type',
                                   '#^' . implode('|',
                                                  self::$ACCORD_CATEGORIES
                                   ) . '$#u',
                                   false,
                                   30,
                                   $type
            );
            $ok &= $this->addField('product_vat' . $index,
                                   'Product tax rate',
                                   '#^((\d{1,12})|(\d{1,2}\.\d{1,4}))$#u',
                                   false,
                                   12,
                                   $vat
            );
        ...
        {
            return $this->addField('ext_info_' . $key,
                                   'Extra info ' . $key,
                                   '#^.{0,255}$#u',
                                   false,
                                   255,
        ...
        /**
         * Return Key according to current mode, false if mode was not set.
         *
         ...
         *
         * @param array[string][Field] $fields already filtered fields list
         * @param bool $hashed
         * @return string
         */
        ...
        )
        {
            ...
            $html .= "\n";
            $html .= $this->getRequestHtmlFields($input_type,
                                                 $input_add,
                                                 $escape
            );
        ...
        public function getRequestFieldsArray ($for_log = false, $escape = true)
        {
                     ...
                     $field)
            {
                ...
                if ($for_log && in_array($field->getName(),
                                         $sensitive_data
                    )) {
                    $value = str_repeat('*',
                                        strlen($value)
