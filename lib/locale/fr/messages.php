...
$i18n['debugdesc'] = 'Pour être redirigé directement sur la page de paiement sans afficher cette page, veuillez passer la valeur debug à <code>false</code> dans le fichier <code>Config.php</code>';
...
$i18n['custfirstname'] = 'Prénom du client. Paramètre facultatif. Longueur du champ: 127 caractères maximum - Type Alphanumérique';
$i18n['custlastname'] = 'Nom du client. Paramètre facultatif. Longueur du champ: 127 caractères maximum - Type Alphanumérique';
...
$i18n['tovalidate'] = "La transaction a été acceptée mais elle est en attente de validation manuelle. C'est à la charge du marchand de valider la transaction pour demander la remise en banque depuis le back office marchand ou par requête web service. La transaction pourra être validée tant que le délai de capture n’a pas été dépassé. Si ce délai est dépassé alors le paiement bascule dans le statut Expiré. Ce statut expiré est définitif.";
$i18n['toauthorise'] = "La transaction est en attente d’autorisation. Lors du paiement uniquement un prise d’empreinte a été réalisée car le délai de remise en banque est strictement supérieur à 7 jours. Par défaut la demande d’autorisation pour le montant global sera réalisée à j-2 avant la date de remise en banque.";
$i18n['expired'] = "La transaction est expirée. Ce statut est définitif, la transaction ne pourra plus être remisée en banque. Une transaction expire dans le cas d'une transaction créée en validation manuelle ou lorsque le délai de remise en banque (capture delay) dépassé.";
$i18n['cancelled'] = "La transaction a été annulée au travers du back office marchand ou par une requête web service. Ce statut est définitif, la transaction ne sera jamais remise en banque.";
$i18n['tovalidate'] = "La transaction est en attente d’autorisation et en attente de validation manuelle. Lors du paiement uniquement un prise d’empreinte a été réalisée car le délai de remise en banque est strictement supérieur à 7 jours et le type de validation demandé est « validation manuelle ». Ce paiement ne pourra être remis en banque uniquement après une validation du marchand depuis le back office marchand ou par un requête web services.";
...
$i18n['05'] = "Paiement annulé par le client.";
...
$i18n['vads_amount'] = "Montant de la transaction exprimé dans la plus petite unité de la monnaie ou devise (le centime pour l'euro)";
$i18n['vads_effective_amount'] = "Montant Effectif";
$i18n['vads_effective_amount_desc'] = "montant du paiement dans la devise réellement utilisée pour effectuer la remise en banque.";
