...
$i18n['debugdesc'] =
    'Um direkt zur Zahlungsseite umgeleitet zu werden, ohne diese Seite anzuzeigen, übergeben Sie den Wert von <code>debug</code> von <code>config.php</code> an <code>false</code>.';
...
$i18n['custfirstname'] =
    'Vorname des Kunden. Optionale Einstellung. Feldlänge: maximal 127 Zeichen - Alphanumerischer Typ';
$i18n['custlastname'] =
    'Nachname des Kunden. Optionale Einstellung. Feldlänge: maximal 127 Zeichen - Alphanumerischer Typ';
...
$i18n['custcountry'] =
    'Kundenland. Ländercode des Kunden gemäß der Norm ISO 3166. Optionale Einstellung. Feldlänge: max. 2 Zeichen - Alphanumerischer Typ';
...
$i18n['urlreturndesc'] =
    'Standard-URL, an die der Käufer weitergeleitet wird. Wenn dieses Feld nicht übertragen wurde, wird die Backoffice-Konfiguration berücksichtigt.';
$i18n['redirect'] =
    'Verzögerung in Sekunden, bevor eine automatische Weiterleitung zur Händler-Website am Ende einer akzeptierten Zahlung erfolgt.';
...
$i18n['ipndesc'] =
    'Nach Abschluss der Zahlung gibt die Zahlungsplattform im POST-Modus Parameter an die Server-URL zurück, die die Zahlungsergebnisse analysieren muss. In einem ersten Schritt muss die empfangene Unterschrift überprüft werden. Wenn dies korrekt ist, können Sie die Parameter berücksichtigen, die sich auf die Zahlung selbst beziehen.';
$i18n['returnurl'] = 'URL zum Shop zurücksenden.';
$i18n['clientcomesback'] =
    'Wenn der Benutzer über eine der Rückgabe-URLs zum Geschäft zurückkehrt, werden die Zahlungsparameter basierend auf der in der Datei conf.txt definierten Variablen vads_return_mode zurückgegeben. Je nach vads_return_mode werden die Parameter im POST / GET-Modus oder gar nicht zurückgegeben.';
$i18n['formreturndesc'] =
...
$i18n['status'] = "Status";
$i18n['abandoned'] =
    "Die Zahlung wurde vom Kunden abgebrochen. Die Transaktion wurde nicht auf der Zahlungsplattform erstellt und ist daher im Händler-Backoffice nicht sichtbar.";
...
$i18n['toauthorise'] =
    "Die Transaktion steht noch aus. Beim Bezahlen wurde nur ein Eindruck hinterlassen, da die Einzahlungszeit strikt länger als 7 Tage ist. Standardmäßig erfolgt die Autorisierungsanforderung für den Gesamtbetrag am zweiten Tag vor dem Bankdatum.";
$i18n['expired'] =
    "Die Transaktion ist abgelaufen. Dieser Status ist endgültig, die Transaktion kann nicht mehr in der Bank gespeichert werden. Eine Transaktion verfällt im Falle einer Transaktion, die bei der manuellen Validierung erstellt wurde oder wenn die Erfassungsverzögerung abgelaufen ist.";
$i18n['cancelled'] =
    "Die Transaktion wurde über das Händler-Backoffice oder über eine Webservice-Anfrage storniert. Dieser Status ist endgültig. Die Transaktion wird niemals als Banküberweisung abgerechnet.";
$i18n['tovalidate'] =
...
$i18n['17'] = "Zahlung vom Kunden storniert.";
